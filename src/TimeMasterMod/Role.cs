...
// Type: TownOfUs.TimeMasterMod.Role
...
namespace TownOfUs.TimeMasterMod
{
  ...
  public static class Role
  {
    ...
    {
      if (Object.op_Equality((Object) FFGALNAPKCD.get_LocalPlayer(), (Object) null) || !__instance.isTimeMaster())
        return;
      ABFBCNBODMA abfbcnbodma = (ABFBCNBODMA) new GameObject("TimeMasterTask").AddComponent<ABFBCNBODMA>();
      ((Component) abfbcnbodma).get_transform().SetParent(((Component) __instance).get_transform(), false);
      abfbcnbodma.set_Text("[0000FFFF]Role: Time Master\nRewind Time![]");
