...
// Type: TownOfUs.SheriffMod.Methods
...
namespace TownOfUs.SheriffMod
{
  public static class Methods
  {
    ...
    {
      TimeSpan timeSpan = DateTime.UtcNow - Methods.LastKilled;
    ...
    {
      Vector2 truePosition1 = refplayer.GetTruePosition();
      Vector2 truePosition2 = player.GetTruePosition();
      return Math.Sqrt(((double) ((Vector2) ref truePosition1).get_Item(0) - (double) ((Vector2) ref truePosition2).get_Item(0)) * ((double) ((Vector2) ref truePosition1).get_Item(0) - (double) ((Vector2) ref truePosition2).get_Item(0)) + ((double) ((Vector2) ref truePosition1).get_Item(1) - (double) ((Vector2) ref truePosition2).get_Item(1)) * ((double) ((Vector2) ref truePosition1).get_Item(1) - (double) ((Vector2) ref truePosition2).get_Item(1)));
    }
  }
}
